...
TEXT = "Witaj świecie! Jak się masz? Mam nadzieję, że dobrze."
...
if __name__ == "__main__":
    ...
    try:
        loop.run_until_complete(_edge_tts())
    finally:
        loop.close()
...
# TEXT = "Lubię jeść jabłka."
# OUTPUT_FILE = "spanish.mp3"


# async def _main() -> None:
#     voices = await VoicesManager.create()
#     voice = voices.find(Gender="Female", Language="pl")
